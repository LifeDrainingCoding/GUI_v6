...
public class HelloApplication extends Application {
    ...
    private VBox editBlock(Organization org) {
        ...
        Button btb = new Button("zxc");
        btb.setFont(Font.font(20));
        btb.setOnAction((ActionEvent event) -> {
            Image imageDog = new Image(getClass().getResourceAsStream("dog.jpg"));
        ...
        editPane.getChildren().addAll(labelTitle, editName, editBonus, btn, btb);
